...
<div class="container-fluid">
    <h1 class="mt-4 mb-3">Create Blogs</h1>
    <form action="/cms/en/campus/post" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="call_centre" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea name="embedded_map" id="" cols="30" rows="10" class="form-control"></textarea>
        </div>
        <div class="form-group">
            <label for="">Image</label>
            <input type="file" class="form-control" name="image" />
        </div>
        <input type="submit" value="Add Campus" class="btn btn-primary mt-3 mb-3">
    </form>
</div>
